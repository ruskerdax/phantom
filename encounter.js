...
function updEnc(){
  ...
  for(let i=enc.bul.length-1;i>=0;i--){
    ...
    if(!hit&&enc.isHBase){
      ...
      for(const t of enc.hbase.turrets){if(!t.alive)continue;if(Math.hypot(b.x-t.x,b.y-t.y)<defenseRadius(t)){damageDefense(enc,t,b.dmg,b.x,b.y);enc.bul.splice(i,1);hit=true;break;}}
