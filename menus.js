...
function drawTitle(){
  ...
  else{cx.fillStyle='#0f8';cx.font='bold 72px MajorMonoDisplay, monospace';cx.fillText('PHANTOM',W/2,H/2-100);}
  cx.shadowBlur=0;cx.fillStyle='#acd';cx.font='14px MajorMonoDisplay, monospace';
  cx.fillText('KILL PHRASE ACTIVATED, EXECUTE PHANTOM PROTOCOL',W/2,H/2-55);
  const rows=[[]];
  cx.font='12px MajorMonoDisplay, monospace';let ry=H/2-22;
  ...
  cx.font='14px MajorMonoDisplay, monospace';
...
function drawScreen(title,sub,tc,prompt){
  ...
  cx.font='bold 52px MajorMonoDisplay, monospace';cx.fillText(title,W/2,H/2-50);
  if(sub){cx.shadowBlur=0;cx.fillStyle='#acd';cx.font='20px MajorMonoDisplay, monospace';cx.fillText(sub,W/2,H/2+12);}
  if(Math.floor(G.fr/28)%2===0){cx.fillStyle='#668';cx.font='14px MajorMonoDisplay, monospace';cx.fillText(prompt,W/2,H/2+65);}
...
function drawShipConfig(){
  ...
  cx.fillStyle='#0f8';cx.font='bold 16px MajorMonoDisplay, monospace';cx.textAlign='center';cx.shadowColor='#0f8';cx.shadowBlur=8;
  ...
  cx.fillStyle='#0f8';cx.font='bold 13px MajorMonoDisplay, monospace';cx.textAlign='center';cx.shadowBlur=6;
...
function drawCheatSub(){
  ...
  cx.shadowBlur=14;cx.fillStyle='#ff8';cx.font='bold 22px MajorMonoDisplay, monospace';cx.textAlign='center';
  cx.fillText('CHEATS',W/2,py+38);
  cx.shadowBlur=6;cx.font='bold 10px MajorMonoDisplay, monospace';cx.fillText('CHEAT MODE',W/2,py+54);cx.shadowBlur=0;
  ...
  cx.shadowBlur=0;cx.fillStyle='#334';cx.font='11px MajorMonoDisplay, monospace';
...
function drawPause(){
  ...
  cx.shadowBlur=14;cx.fillStyle='#0f8';cx.font='bold 22px MajorMonoDisplay, monospace';cx.textAlign='center';
  cx.fillText('PAUSED',W/2,py+38);
  if(G.cheatMode){cx.shadowBlur=6;cx.fillStyle='#ff8';cx.font='bold 10px MajorMonoDisplay, monospace';cx.fillText('CHEAT MODE',W/2,py+54);cx.shadowBlur=0;}
  cx.font='13px MajorMonoDisplay, monospace';
  ...
  if(G.cheatMode){cx.fillStyle='#223';cx.font='10px MajorMonoDisplay, monospace';
...
function drawOptions(){
  ...
  cx.font='bold 28px MajorMonoDisplay, monospace';cx.fillText('OPTIONS',W/2,70);
  ...
  for(let i=0;i<items.length;i++){
    ...
    cx.font='bold 13px MajorMonoDisplay, monospace';
...
function drawClearDataDialog(){
  ...
  cx.shadowBlur=0;cx.fillStyle='#f84';cx.font='bold 14px MajorMonoDisplay, monospace';cx.textAlign='center';
  cx.fillText('CLEAR ALL GAME DATA?',W/2,py+28);
  cx.shadowBlur=0;cx.fillStyle='#acd';cx.font='12px MajorMonoDisplay, monospace';
  ...
  for(let b=0;b<2;b++){
    ...
    cx.fillStyle=isSel?'#0f8':'#668';cx.font='bold 11px MajorMonoDisplay, monospace';cx.textAlign='center';
...
function drawControls(){
  ...
  cx.save();cx.textAlign='center';
  cx.shadowColor='#0f8';cx.shadowBlur=20;cx.fillStyle='#0f8';
  cx.font='bold 28px MajorMonoDisplay, monospace';cx.fillText('CONTROLS',W/2,44);
  cx.shadowBlur=0;cx.strokeStyle='#1a4a2a';cx.lineWidth=1;
  cx.beginPath();cx.moveTo(60,58);cx.lineTo(W-60,58);cx.stroke();
  const col0=160,col1=370,col2=580;
  cx.font='bold 11px MajorMonoDisplay, monospace';cx.fillStyle='#446';
  ...
  cx.textAlign='center';cx.font='bold 13px MajorMonoDisplay, monospace';
...
function updCheatMenu(m){
  ...
  if(id==='repair'){
    fillShipHull(G.OW.s);fillShipEnergy(G.OW.s);
