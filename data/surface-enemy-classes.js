...
const SURFACE_ENEMY_CLASSES = [
  {
    ...
    surf:{hp:20, r:11, spd:2.8, fire:{wpn:'mass driver small', offset:13, arc:Math.PI, senseRange:460}},
  ...
  },
  {
    ...
    surf:{hp:20, r:12, spd:3.8, fire:{wpn:'mass driver small', offset:13, arc:Math.PI, senseRange:460}},
    drawSurface(e){drawSurfaceHullEnemy(this,e);}
  },
  {
