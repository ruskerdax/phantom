...
// ---- Fleet registry ----
// Fleet compositions reference enemy role/type IDs, not concrete enemy class IDs or class-array positions.
...
const FLEETS = [
  { id:'HUNTER',  aggroR:600, trigR:24, owSpd:3.0, maxOnOW:3,
    ...
    composition:{ rolls:[
      ...
      { t:ENEMY_TYPES.FIGHTER, min:1, max:2 },
  ...
  { id:'PATROL',  aggroR:360,  trigR:24, owSpd:3.0,  maxOnOW:2,
    ...
    composition:{ rolls:[
      ...
      { t:ENEMY_TYPES.DESTROYER, cnt:1, chance:.5 },
      { t:ENEMY_TYPES.CRUISER, cnt:1, chance:.2 },
      { t:ENEMY_TYPES.INTERCEPTOR, min:1, max:3 },
      { t:ENEMY_TYPES.FIGHTER, min:1, max:2 },
  ...
  { id:'CONVOY',  aggroR:0,    trigR:26, owSpd:2.0,  maxOnOW:2,
    ...
    composition:{ rolls:[
      { t:ENEMY_TYPES.CARRIER, cnt:1 },
      { t:ENEMY_TYPES.DESTROYER, cnt:1, chance:.5 },
      { t:ENEMY_TYPES.CRUISER, cnt:1, chance:.3 },
      { t:ENEMY_TYPES.INTERCEPTOR, min:1, max:3 },
      { t:ENEMY_TYPES.FIGHTER, min:1, max:2 },
      { t:ENEMY_TYPES.DRONE, min:0, max:2 }
    ]},
  ...
  { id:'ARMADA',  aggroR:512,  trigR:28, owSpd:1.5,  maxOnOW:1,
    ...
    composition:{ rolls:[
      ...
      { t:ENEMY_TYPES.CARRIER, cnt:1, chance:.5 },
      { t:ENEMY_TYPES.DESTROYER, min:1, max:3 },
      { t:ENEMY_TYPES.CRUISER, min:0, max:2 },
      { t:ENEMY_TYPES.INTERCEPTOR, min:2, max:4 },
      { t:ENEMY_TYPES.FIGHTER, min:1, max:3 },
      { t:ENEMY_TYPES.DRONE, min:0, max:3 }
    ]},
    glyph:'armada' }
];
